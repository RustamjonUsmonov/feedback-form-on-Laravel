                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <img
                                                                ...
                                                                width="70"
                                                                src="https://icon-library.com/images/flat-user-icon/flat-user-icon-12.jpg"
                                                                border="0" alt="icon">
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table border="0" align="left" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td class="center-text" align="left"
                                                            ...
                                                            <div>
                                                                {{ __('Имя пользователя') }} : <b>{{ $mailMessage['fullname']}}</b>
                                                    ...
                                                    <tr>
                                                        <td class="center-text container-padding" align="left"
                                                            ...
                                                            <div>
                                                                {{ __('Сообщение') }} : {{ $mailMessage['message']}}
                                                            </div>
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row"
                ...
                <tr>
                    <td class="center-text" align="center"
                        ...
                        <a href="{{ url('/') }}" style="color:#6e6e6e;"><span>{{ url('/') }}</span></a>
